...
keep deans* edwardss* sigmaeta sigma1-sigma10 alpha1-alpha10 beta1-beta10 mud* mue* n1-n10 B1xone B2xone ldean* ledwards* 
drop if _n>1
...
save bresults_nodist.dta, replace
